    ...
    <footer className="bg-levain-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="font-optima text-2xl mb-4">Levain Cafe</h3>
            <p className="text-white/70 mb-6">
              Artisan sourdough and specialty coffee in a warm, welcoming
              environment.
            </p>
          </div>

          <div>
            <h4 className="font-optima text-xl mb-4">Quick Links</h4>
          ...
          <div>
            <h4 className="font-optima text-xl mb-4">Newsletter</h4>
            <p className="text-white/70 mb-4">
              Subscribe to receive updates on seasonal menus, events, and
              special offers.
            </p>
            <form className="flex">
              <input
